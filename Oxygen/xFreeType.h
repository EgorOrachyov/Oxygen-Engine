 ...
 *  Copyright
 *
 *  xFreeType fonts for rendering in the
 *  OpenGL based program
 */

#ifndef OXYGEN_XFREETYPE_H
#define OXYGEN_XFREETYPE_H
...
// Восстановить координаты матрицы проекции.
    ...
    void print(const font_data &ft_font, float x, float y, const char *fmt, ...)  {
        ...
        if(start_line) {
            string line;
            for(const char *n=start_line; *n != '\0';n++) line.append(1,*n);
            lines.push_back(line);
        }
